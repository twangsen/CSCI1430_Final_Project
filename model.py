...
loadedImages = np.expand_dims(loadedImages, axis=3)

outputVectors = np.zeros((train_size * class_num, class_num))
for j in range(0, class_num):
    outputVectors[j*train_size: j*train_size + train_size, j] = 1
